var arrOfImages = ["Cells.png", "Gong.png", "Dwayne.png", "Homer.png", "Horse.png", "Keanu.png", "Matt.png", "Shark.png", "Steve.png"];
...
function displayCards(arr) {
    ...
    for (var i = 0; i < arr.length; i++) {
        ...
        newImgElement.src = "images/" + arr[i];
...
function hideACard(idx) {
    ...
    specificCard.src = "images/questionmark.png";
}
...
doubleImages(arrOfImages);    // create 2 of each images
suffleCards(arrOfImages);     // suffle the cards
